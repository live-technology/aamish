const messages: Record<string, string> = {
  ...
  EMPLOYEE_UPDATE_FAILED: "The employee could not be updated. Check the details and try again.",
  EMPLOYEE_REMOVE_FAILED: "The employee could not be removed. Try again or share the request ID with support.",
  ENTERPRISE_ADMIN_NOT_FOUND: "This enterprise does not have an administrator account to reset.",
  ...
  FOOD_QUALITY_REPORT_FAILED: "The food-quality issue could not be sent. Try again or share the request ID with support.",
  FOOD_QUALITY_REPORT_NOT_AVAILABLE: "This meal is not available for a food-quality report.",
  INVALID_FOOD_QUALITY_REPORT: "Describe the food-quality issue before sending it.",
  ...
  INVALID_TEMPORARY_PASSWORD: "Temporary passwords must contain at least 8 characters.",
  ...
  PASSWORD_RESET_FAILED: "The temporary password could not be set. Try again or share the request ID with support.",
