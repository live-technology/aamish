...
import { EnterprisePortal, type Employee, type EnterpriseOrder } from "@/components/enterprise-portal";
...
export default async function EnterprisePage() {
  ...
  const [enterpriseRows, locations, employees, orders] = await Promise.all([
  ...
  return <EnterprisePortal enterpriseName={enterpriseRows[0].name} fullName={session.fullName} locations={[...locations]} initialEmployees={[...employees]} orders={[...orders]}/>;
}
