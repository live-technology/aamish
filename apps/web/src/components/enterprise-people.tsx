...
import { Download, FileUp, MapPin, Plus, Search, Users, X } from "lucide-react";
...
export type EnterpriseEmployee = { id: string; employee_code: string; full_name: string; email: string; phone: string | null; location_name: string; username: string; is_active: boolean };
